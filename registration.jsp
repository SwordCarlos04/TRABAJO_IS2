			...
			<div class="container">
				<div class="signup-content">
						...
						<form method="" action="" class="register-form"
							...
							<div class="form-group">
								<input type="checkbox" name="agree-term" id="agree-term"
									...
									class="label-agree-term"><span><span></span></span>Estoy de acuerdo con los <a href="#" class="term-service">Términos y Condiciones</a></label>
							</div>
					...
					<div class="signup-image">
						...
						<a href="login.jsp" class="signup-image-link">Tengo cuenta</a>
					</div>
				</div>
			</div>
		</section>
